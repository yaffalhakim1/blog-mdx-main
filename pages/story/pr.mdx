...
<Callout type="info" emoji="ℹ️">
  ...
  pages to your native language. You can find more information about how to do
  this in the [ReactJS Translation Guide for Indonesian
  Language](https://github.com/reactjs/id.react.dev/issues/330)
</Callout>
...
- [Sharing State Between Components](https://github.com/reactjs/id.react.dev/pull/370) merged coming soon
